...
contextBridge.exposeInMainWorld('gitOps', {
  ...
  generatePRMsg: (workDir) => ipcRenderer.invoke('git:generate-pr-msg', workDir),
...
contextBridge.exposeInMainWorld('github', {
  ...
  issueEdit: (workDir, number, changes) => ipcRenderer.invoke('gh:issue-edit', workDir, number, changes),
  issueClose: (workDir, number) => ipcRenderer.invoke('gh:issue-close', workDir, number),
  issueReopen: (workDir, number) => ipcRenderer.invoke('gh:issue-reopen', workDir, number),
